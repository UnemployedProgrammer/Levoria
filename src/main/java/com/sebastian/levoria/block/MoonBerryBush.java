...
public class MoonBerryBush extends SweetBerryBushBlock {
    public MoonBerryBush(Settings settings) {
        super(settings);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.MOON_BERRIES, j + (bl ? 1 : 0)));
